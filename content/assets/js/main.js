...
const toggleSidebar = () => {
  if (sidebar.classList.contains('!translate-x-0')) {
    sidebar.classList.remove('!translate-x-0 md:relative md:translate-x-0 w-3/4 md:basis-60')
    menuOpacity.classList.add('hidden')
  } else {
    sidebar.classList.add('!translate-x-0 md:relative md:translate-x-0 w-3/4 md:basis-60')
